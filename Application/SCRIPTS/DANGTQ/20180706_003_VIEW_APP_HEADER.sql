...
-- Generated 07-Jul-2018 00:16:44 from LEGALTECH@LOCALHOST
...
SELECT  A."ID",A."APPCODE",A."MASTER_NAME",A."MASTER_ADDRESS",A."MASTER_PHONE",A."REP_MASTER_TYPE",A."REP_MASTER_NAME",A."REP_MASTER_ADDRESS",
    ...
    AL1.CONTENT AS STATUS_NAME, AL2.CONTENT AS STATUS_FORMM_NAME, AL3.CONTENT AS STATUS_CONTENT_NAME,SA.APPNAME,client_reference, case_name
