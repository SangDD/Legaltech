...
-- Generated 10-Jul-2018 0:11:27 from LEGALTECH@LOCALHOST
...
BEGIN
    ...
    IF v_case_code <> 'ALL' THEN
        V_CONDITION :=  V_CONDITION || ' AND UPPER(A.gencode) LIKE ''%' || UPPER(v_case_code) || '%'' ';
    END IF;
    ...
    ELSE
        V_SQL :=  V_SQL || ' ORDER BY A.CREATED_DATE';
    END IF;
