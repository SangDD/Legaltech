...
-- Generated 13-Jun-2018 22:27:01 from LEGALTECH@LOCALHOST
...
BEGIN
    ...
    IF(V_EXISTED = 0) THEN
        ...
        (
            ...
            reason_select, request_credit, other_type, hourly_rate,customer_code
        ...
        (
            ...
            p_reason_select, p_request_credit, p_other_type, p_hourly_rate, p_customer_code
        );
