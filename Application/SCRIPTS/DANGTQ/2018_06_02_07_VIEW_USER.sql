...
-- Generated 02/06/2018 11:55:04 PM from LEGALTECH@LOCALHOST
...
CREATE OR REPLACE VIEW view_users (
   ...
   request_credit_name )
AS
SELECT a."ID",a."USERNAME",a."PASSWORD",a."FULLNAME",a."DATEOFBIRTH",a."SEX",a."EMAIL",a."PHONE",a."TYPE",a."STATUS",a."CREATEDBY",a."CREATEDDATE",a."MODIFIEDBY",a."MODIFIEDDATE",a."DELETED",a."ADDRESS",a."FAX",a."COUNTRY",a."COMPANY_NAME",a."MAIN_BUSINESS",a."TITLE",a."COPYTO",a."FACE_LINK",a."LINKEDIN_LINK",a."WECHAT_LINK",a."OTHER_LINK",a."REASON_SELECT",a."REQUEST_CREDIT",a."OTHER_TYPE",a."HOURLY_RATE", t1.content AS SexDisplayName, t2.content AS StatusDisplayName, t3.content AS Type_Name,
