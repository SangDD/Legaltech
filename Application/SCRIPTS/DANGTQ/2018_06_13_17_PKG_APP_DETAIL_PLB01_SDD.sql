...
-- Generated 14-Jun-2018 00:14:21 from LEGALTECH@LOCALHOST
...
BEGIN
    ...
    (
        id, app_header_id, appcode, request_change_type, app_no_change, request_to_type, request_to_content, language_code,number_pic,number_page

    )
    VALUES
    (
        v_id, p_app_header_id, p_appcode, p_request_change_type, p_app_no_change, p_request_to_type, p_request_to_content, p_language_code,p_number_pic,p_number_page
