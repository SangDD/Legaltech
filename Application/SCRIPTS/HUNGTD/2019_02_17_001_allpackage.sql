...
-- Generated 17-Feb-2019 00:20:46 from LEGALCODE@LEGALONLINE
...
-- Generated 17-Feb-2019 00:20:47 from LEGALCODE@LEGALONLINE
...
BEGIN
    ...
    IF P_STATUS = pkg_common.APP_STATUS_WAIT_GRANT_ADMIN THEN
...
-- Generated 17-Feb-2019 00:20:48 from LEGALCODE@LEGALONLINE
...
BEGIN
    ...
    -- type
    IF V_TYPE =  'TODO' THEN
        V_CONDITION :=  V_CONDITION || ' AND UPPER(A.processor_by_name) = ''' || UPPER(P_USER_NAME) || ''' ';
    ELSIF V_TYPE =  'ORDER' THEN
        V_CONDITION :=  V_CONDITION || ' AND UPPER(A.request_by_name) = ''' || UPPER(P_USER_NAME) || ''' ';
...
BEGIN
   ...
   FROM WIKI_DOCS A WHERE UPPER(A.CREATED_BY) = UPPER(V_CREATED_BY);
    ...
    UPDATE S_USERS A SET A.RATING =  V_TOTAL_RATE WHERE UPPER( A.USERNAME) = UPPER(V_CREATED_BY) AND DELETED = 0;
