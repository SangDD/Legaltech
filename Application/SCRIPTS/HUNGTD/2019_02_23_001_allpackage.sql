-- Start of DDL Script for Package LEGALCODE.PKG_ALLCODE
-- Generated 23-Feb-2019 22:26:00 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_ALLCODE

-- Start of DDL Script for Package LEGALCODE.PKG_APP_CLASS
-- Generated 23-Feb-2019 22:26:00 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_CLASS

-- Start of DDL Script for Package LEGALCODE.PKG_APP_DDSHCN
-- Generated 23-Feb-2019 22:26:00 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_DDSHCN

-- Start of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_01
-- Generated 23-Feb-2019 22:26:00 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_01

-- Start of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_04NH
-- Generated 23-Feb-2019 22:26:00 from LEGALCODE@LEGALONLINE
...
(
    ...
    P_THOATHUANKHAC IN VARCHAR2 ,
     P_LOGOCHU IN NUMBER DEFAULT 0,
     P_LOGO_FONT_SIZE IN NUMBER DEFAULT 0,
    P_FONTTYPE IN VARCHAR2 DEFAULT '',
    P_RETURN OUT NUMBER
);
...
(
    ...
    P_YCCAPPHO4 IN VARCHAR2 ,
    P_THOATHUANKHAC IN VARCHAR2 ,
    --PHAN BIET LOGO LA CHU HAY LA ANH, 0: LA ANH, 1: LA CHU
    P_LOGOCHU IN NUMBER DEFAULT 0,
    P_LOGO_FONT_SIZE IN NUMBER DEFAULT 0,
    P_FONTTYPE IN VARCHAR2 DEFAULT '',
    P_RETURN OUT NUMBER
...
BEGIN
    ...
    (
            ...
            THOATHUANKHAC,LOGOCHU,LOGO_FONT_SIZE,FONTTYPE
    )
    VALUES
    (
        ...
        P_YCCAPPHO3,P_YCCAPPHO4 ,P_THOATHUANKHAC,P_LOGOCHU ,P_LOGO_FONT_SIZE,P_FONTTYPE
    );
...
BEGIN
    ...
    LOGOCHU =P_LOGOCHU,
    LOGO_FONT_SIZE = P_LOGO_FONT_SIZE,
    FONTTYPE = P_FONTTYPE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_04NH

-- Start of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_PLB01_SDD
-- Generated 23-Feb-2019 22:26:00 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_PLB01_SDD

-- Start of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_PLB02_CGD
-- Generated 23-Feb-2019 22:26:00 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_PLB02_CGD

-- Start of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_PLC05_KN
-- Generated 23-Feb-2019 22:26:00 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_PLC05_KN

-- Start of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_PLD01_CHDCN
-- Generated 23-Feb-2019 22:26:00 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_PLD01_CHDCN

-- Start of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_PLD01_HDCN
-- Generated 23-Feb-2019 22:26:00 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_PLD01_HDCN

-- Start of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_TM06DKQT
-- Generated 23-Feb-2019 22:26:00 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_DETAIL_TM06DKQT

-- Start of DDL Script for Package LEGALCODE.PKG_APP_DOC_OTHERS
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_DOC_OTHERS

-- Start of DDL Script for Package LEGALCODE.PKG_APP_DOCUMENT
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
BEGIN
    ...
    -- UPDATE BAN GHI CU tru¿ng ID d¿ch
    ...
    -- update b¿n ghi ti¿ng vi¿t
    UPDATE APPLICATION_HEADER a SET a.created_by =
    (
        -- l¿y created by c¿a b¿n du¿c d¿ch
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_DOCUMENT

-- Start of DDL Script for Package LEGALCODE.PKG_APP_FEE_FIX
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_FEE_FIX

-- Start of DDL Script for Package LEGALCODE.PKG_APP_GET_DATA
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
BEGIN
    ...
    -- b¿ di¿u ki¿n AND  LANGUAGUE_CODE ='EN_US'
    OPEN  P_CURSOR FOR
    ...
    WHERE  1 = 1
    --A.LANGUAGUE_CODE = P_LANGUAGE AND -- dangtq b¿ di vì gi¿ d¿ch c¿ vi¿t sang anh và ngu¿c l¿i
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_GET_DATA

-- Start of DDL Script for Package LEGALCODE.PKG_APP_HEADER
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_HEADER

-- Start of DDL Script for Package LEGALCODE.PKG_APP_LAWER
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_LAWER

-- Start of DDL Script for Package LEGALCODE.PKG_APP_NOTICE_INFO
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
BEGIN
    ...
    -- n¿u admin duy¿t thi update th¿ng billing dó
...
-- update file công van tr¿ l¿i c¿c t¿ d¿ng h¿ th¿ng k¿t xu¿t ra
PROCEDURE proc_ls_update_cv_auto
(
    p_case_code IN app_notice_info.case_code % TYPE,
    p_notice_type IN app_notice_info.notice_type % TYPE,
...
-- End of DDL Script for Package LEGALCODE.PKG_APP_NOTICE_INFO

-- Start of DDL Script for Package LEGALCODE.PKG_APPCLASS_DETAIL
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_APPCLASS_DETAIL

-- Start of DDL Script for Package LEGALCODE.PKG_COMMON
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_COMMON

-- Start of DDL Script for Package LEGALCODE.PKG_BILLING
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
BEGIN
    ...
    -- không cho phép khách và nhân viên x¿ lý xem billing
...
-- End of DDL Script for Package LEGALCODE.PKG_BILLING

-- Start of DDL Script for Package LEGALCODE.PKG_DOCKING
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_DOCKING

-- Start of DDL Script for Package LEGALCODE.PKG_LOG
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_LOG

-- Start of DDL Script for Package LEGALCODE.PKG_GET_CUSTOMER_INFO
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_GET_CUSTOMER_INFO

-- Start of DDL Script for Package LEGALCODE.PKG_LAWER_INFO
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_LAWER_INFO

-- Start of DDL Script for Package LEGALCODE.PKG_NEWS
-- Generated 23-Feb-2019 22:26:01 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_NEWS

-- Start of DDL Script for Package LEGALCODE.PKG_ORDERS
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_ORDERS

-- Start of DDL Script for Package LEGALCODE.PKG_REGISTOR
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_REGISTOR

-- Start of DDL Script for Package LEGALCODE.PKG_REMIND
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_REMIND

-- Start of DDL Script for Package LEGALCODE.PKG_S_FUNCTION
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_S_FUNCTION

-- Start of DDL Script for Package LEGALCODE.PKG_S_GROUPS
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_S_GROUPS

-- Start of DDL Script for Package LEGALCODE.PKG_S_MENU
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_S_MENU

-- Start of DDL Script for Package LEGALCODE.PKG_S_USERS
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_S_USERS

-- Start of DDL Script for Package LEGALCODE.PKG_SEARCH_CLASS_DETAIL
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_SEARCH_CLASS_DETAIL

-- Start of DDL Script for Package LEGALCODE.PKG_SEARCH_FEE
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_SEARCH_FEE

-- Start of DDL Script for Package LEGALCODE.PKG_SEARCH_OBJECTS
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_SEARCH_OBJECTS

-- Start of DDL Script for Package LEGALCODE.PKG_SYS_APPLICATION
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_SYS_APPLICATION

-- Start of DDL Script for Package LEGALCODE.PKG_SYS_SEARCH_FIX
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_SYS_SEARCH_FIX

-- Start of DDL Script for Package LEGALCODE.PKG_TIMESHEET
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
BEGIN
    ...
    -- không cho phép khách và nhân viên x¿ lý xem timesheet
    IF v_user_type = pkg_common.USER_TYPE_EMPOYEE OR v_user_type = pkg_common.USER_TYPE_CUSTOMER THEN
        OPEN P_CURSOR FOR
        SELECT  A.* FROM VIEW_TIMESHEET A WHERE  1 = 0;
        RETURN;
...
-- End of DDL Script for Package LEGALCODE.PKG_TIMESHEET

-- Start of DDL Script for Package LEGALCODE.PKG_TODOS
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
BEGIN
    SELECT case_code INTO v_case_code FROM application_header a WHERE a.id = p_app_id;
    UPDATE b_todos a SET a.status = 1, a.processor_date = SYSDATE
    WHERE case_code = v_case_code AND status = 0 AND a.processor_by = p_processor_by;
COMMIT;
END;
...
-- End of DDL Script for Package LEGALCODE.PKG_TODOS

-- Start of DDL Script for Package LEGALCODE.PKG_WIKI_CATALOUGE
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
-- End of DDL Script for Package LEGALCODE.PKG_WIKI_CATALOUGE

-- Start of DDL Script for Package LEGALCODE.PKG_WIKI_DOCS
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
(
    ...
    P_HEADER IN WIKI_DOCS.HEADER % TYPE,
...
P_RETURN := V_ID;
    ...
    (
         ...
         FILE_URL02, FILE_URL03, STATUS,  CASE_CODE, HEADER
    )
    VALUES
    (
        V_ID, P_TITLE, P_CONTENT,  P_CREATED_BY,
         TRUNC(P_CREATED_DATE), P_LANGUAGE_CODE, P_HASHTAG,
         P_FILE_URL01, P_FILE_URL02, P_FILE_URL03, P_STATUS,  V_CASE_CODE, P_HEADER
     );
...
-- End of DDL Script for Package LEGALCODE.PKG_WIKI_DOCS

-- Start of DDL Script for Package LEGALCODE.PKG_WIKI_PORTAL
-- Generated 23-Feb-2019 22:26:02 from LEGALCODE@LEGALONLINE
...
BEGIN
    ...
    V_SQL := 'SELECT  A.ID, A.TITLE, A.HEADER,  A.VIEW_NUMBER, A.CREATED_BY,
        A.CREATED_DATE, A.MODIFIED_BY, A.MODIFIED_DATE, A.DELETED,
        A.LANGUAGE_CODE, A.HASHTAG, A.FILE_URL01, A.FILE_URL02,
        A.FILE_URL03, A.STATUS, C.ID AS CATA_ID, C.NAME AS CATA_NAME FROM WIKI_DOCS A INNER JOIN WIKI_DOCS_CATALOGUES B
        ON A.ID = B.DOC_ID INNER JOIN WIKI_CATALOGUES
...
-- End of DDL Script for Package LEGALCODE.PKG_WIKI_PORTAL
