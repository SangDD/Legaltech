   ...
   public class WikiDoc_BL: RepositoriesBL
    {
        public decimal WikiDoc_Insert(WikiDoc_Info p_ObjInffo)
        {
            try
            {
                ...
                return _da.WikiDoc_Insert(p_ObjInffo.TITLE, p_ObjInffo.HEADER, p_ObjInffo.CONTENT, p_ObjInffo.LANGUAGE_CODE, p_ObjInffo.CREATED_BY,
        ...
        public decimal WikiDoc_Update(WikiDoc_Info p_ObjInffo)
        {
            ...
            {
                WikiDoc_DA _da = new WikiDoc_DA();
                return _da.WikiDoc_Update(p_ObjInffo.ID, p_ObjInffo.TITLE, p_ObjInffo.HEADER, p_ObjInffo.CONTENT, p_ObjInffo.LANGUAGE_CODE, p_ObjInffo.MODIFIED_BY,
