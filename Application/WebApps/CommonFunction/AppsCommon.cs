    ...
    public class AppsCommon
    {
        ...
        public static string SetContentMailTemplate2(string content, string yourref = "", string outref = "", string dearname = "")
        {
            ...
            try
            {
                ...
                _content = " <head>" +
                    "<style>  table.column-1-2 {  margin-right: 25px;  } @media only screen and (max-width: 640px) {  .container { width: 100% !important;  max-width: 100% !important;  }.container .remove{display: none;}table.column-1-2 {  float: none !important; margin-right: 0 !important;  width: 100% !important; text-align: center !important; }.right{margin-left: 0 !important;}} @media only screen and (min-width: 641px) { .container {  max-width: 800px !important;  }.container .column-1-22{display: none !important;} }</style>  " +
                    "</head> " +
                    "<div style='margin: 0; font-family: 'Source Sans Pro', sans-serif; font-size: 14px;'>" +
                    " <table style='border-collapse: collapse;' width='800' cellspacing='0' cellpadding='0' border='0' align='center'><tr> <td style='padding: 50px 0;'> <div style='max-width: 100%; margin: 0 auto;'>  <table class='container' style='border-collapse: collapse;' width='100%' cellspacing='0' cellpadding='0' border='0' align='center'>  <tbody><tr>  <td> " +

                    "<table width='800' style='border-collapse:collapse;' cellspacing='0' cellpadding='0' border='0'> <tr><td style='text-align:right'><img style='width:auto; height:110px' src='https://ci3.googleusercontent.com/proxy/Mcs1RNQrQZbufG-ry8_77wBxPn1TQ30a6rvW64dc0GEYKq5EKz0YACQ1Fb1yqwNOJAMPqj4ea2ru4naJfvFbfCg8hImIOD20tQ=s0-d-e1-ft#https://pathlaw.net/Content/News/images/logo_ipace.png'><div style='padding:7px 15px 7px 0; font-family: Roboto,sans-serif; color:#5a5a5a'>ACCESS.IP SOLUTION</div> </td></tr></table>" +
