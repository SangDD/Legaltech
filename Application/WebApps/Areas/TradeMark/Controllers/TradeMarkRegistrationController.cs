namespace WebApps.Areas.TradeMark.Controllers
{
    ...
    public class TradeMarkRegistrationController : Controller
    {
        ...
        public ActionResult TradeMarkChoiseApplication()
        {
            ...
            {
                return PartialView("~/Areas/TradeMark/Views/F04/_PartalDangKyNhanHieuForeign.cshtml");
            }
        ...
        public ActionResult TradeMarkView(decimal pAppHeaderId, string pAppCode, int pStatus)
        {
            ...
            else if (pAppCode == TradeMarkAppCode.AppCode_LPT)
            {
                ...
                return PartialView("~/Areas/Patent/Views/Lao_PT/_Partial_Lao_PT_View.cshtml");
            }
        ...
        public ActionResult AppDonDangKyNNInsert(ApplicationHeaderInfo pInfo, App_Detail_F04_Info pDetail, List<AppDocumentInfo> pAppDocumentInfo,
            List<AppDocumentOthersInfo> pAppDocOtherInfo, List<UTienInfo> pUTienInfo)
        {
            try
            {
                Application_Header_BL objBL = new Application_Header_BL();
                ...
                using (var scope = new TransactionScope())
                {
                    ...
                    if (pAppHeaderID >= 0)
                    {
                        ...
                        {
                            pDetail.Sodon_ut = pUTienInfo[0].UT_SoDon;
                            pDetail.Nuocnopdon_ut = pUTienInfo[0].UT_QuocGia;
                            pDetail.Ngaynopdon_ut = pUTienInfo[0].UT_NgayNopDon;
                        }
        ...
        [HttpPost]
        [Route("edit-dang-ky-nhan-hieu_nn")]
        public ActionResult AppDonDangKyEditNN(ApplicationHeaderInfo pInfo, App_Detail_F04_Info pDetail,
        ...
        public ActionResult ExportData_ViewNN(decimal pAppHeaderId, string p_appCode, decimal p_View_Translate)
        {
            try
            {
                ...
                if (pUTienInfo != null && pUTienInfo.Count > 0)
                {
                    app_Detail.Sodon_ut = pUTienInfo[0].UT_SoDon;
