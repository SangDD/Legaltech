        ...
        public ActionResult Do_Lawer_Notice_Form(App_Notice_Info pInfo)
        {
            try
            {
                ...
                if (_ck == 0)
                {
                    ...
                    var url_File_AtachmentTrans = AppLoadHelpers.PushFileToServer(pInfo.File_Notice_Trans_Url, AppUpload.App);
                    ...
                    if (_ck > 0)
                    {
                        ...
                        Insert_Docketing(pInfo.Case_Code, "File scan transalte accept form", url_File_AtachmentTrans);
                    }
                }
