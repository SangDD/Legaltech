...
namespace ObjectInfos
{
    ...
    public class App_Detail_C01_Info : ApplicationHeaderInfo
    {
        ...
        public App_Detail_C01_Info()
        {

        }

        public App_Detail_C01_Info(App_Detail_C01_Info p_app_detail, ApplicationHeaderInfo p_app_header)
        {
        ...
        public decimal Fee_Id_11 { get; set; }
        public decimal Fee_Id_11_Check { get; set; }
        public string Fee_Id_11_Val { get; set; }

        public decimal Fee_Id_12 { get; set; }
        public decimal Fee_Id_12_Check { get; set; }
        public string Fee_Id_12_Val { get; set; }
        ...
        public decimal Fee_Id_31 { get; set; }
        public decimal Fee_Id_31_Check { get; set; }
        public string Fee_Id_31_Val { get; set; }

        public decimal Fee_Id_32 { get; set; }
        public decimal Fee_Id_32_Check { get; set; }
        public string Fee_Id_32_Val { get; set; }
