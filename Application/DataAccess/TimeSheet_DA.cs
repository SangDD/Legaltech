...
namespace DataAccess
{
    public class TimeSheet_DA
    {
        ...
        public DataSet Timesheet_Search(string p_key_search, string p_from, string p_to, string p_sort_type, ref decimal p_total_record)
        {
            try
            {
        ...
        public decimal Timesheet_Update(decimal p_id, string p_name, DateTime p_time_date, decimal p_hours, string p_notes, 
            string p_modify_by, DateTime p_modify_date)
        {
            try
            {
                var paramReturn = new OracleParameter("p_return", OracleDbType.Int32, ParameterDirection.Output);
