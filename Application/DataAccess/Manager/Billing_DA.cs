...
namespace DataAccess
{
    ...
    {
        public DataSet Billing_Search(string p_user_name, string p_key_search, string p_from, string p_to, string p_sort_type, ref decimal p_total_record)
        {
            try
            {
        ...
        public DataSet Billing_GetBy_Id(decimal p_billing_id, string p_language_code)
        {
            try
            {
                return OracleHelper.ExecuteDataset(Configuration.connectionString, CommandType.StoredProcedure, "pkg_billing.proc_billing_getbyid_2",
                    new OracleParameter("p_billing_id", OracleDbType.Decimal, p_billing_id, ParameterDirection.Input), 
                    new OracleParameter("p_language_code", OracleDbType.Varchar2, p_language_code, ParameterDirection.Input),
                    new OracleParameter("p_cursor", OracleDbType.RefCursor, ParameterDirection.Output),
                    new OracleParameter("p_cursor_detail", OracleDbType.RefCursor, ParameterDirection.Output),
        ...
        public decimal Billing_Insert(string p_case_code, decimal p_billing_type, string p_app_case_code, DateTime p_billing_date, DateTime p_deadline,
            ...
            string p_currency, decimal p_currency_rate, string p_created_by, DateTime p_created_date, string p_language_code, string p_notes, decimal p_percent_discount, decimal p_Discount_Fee_Service)
        {
            try
            {
                var paramReturn = new OracleParameter("p_return", OracleDbType.Int32, ParameterDirection.Output);
                OracleHelper.ExecuteNonQuery(Configuration.connectionString, CommandType.StoredProcedure, "pkg_billing.Proc_Billing_Header_Insert",
                     ...
                     new OracleParameter("p_percent_discount", OracleDbType.Decimal, p_percent_discount, ParameterDirection.Input),
                     new OracleParameter("p_discount", OracleDbType.Decimal, p_Discount_Fee_Service, ParameterDirection.Input),
                    paramReturn);
        ...
        public decimal Billing_Update(decimal p_billing_id, DateTime p_billing_date, DateTime p_deadline,
            ...
            string p_currency, decimal p_currency_rate, string p_modify_by, DateTime p_modify_date, string p_language_code, decimal p_percent_discount, decimal p_Discount_Fee_Service)
        {
            try
            {
                var paramReturn = new OracleParameter("p_return", OracleDbType.Int32, ParameterDirection.Output);
