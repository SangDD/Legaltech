        ...
        public decimal Insert(A03_Info pInfo)
        {
            try
            {
                ...
                OracleHelper.ExecuteNonQuery(Configuration.connectionString, CommandType.StoredProcedure, "PKG_A03.PROC_APP_DETAIL_A03_INSERT",
                    ...
                    new OracleParameter("P_REFAPPNO", OracleDbType.Varchar2, pInfo.Refappno == null ? "" : pInfo.Refappno, ParameterDirection.Input),
                    new OracleParameter("P_APP_SENTDATE", OracleDbType.Date, pInfo.App_Sentdate, ParameterDirection.Input),
                    new OracleParameter("P_INDUSTRY_DESIGN_NAME", OracleDbType.Varchar2, pInfo.Industry_Design_Name == null ? "" : pInfo.Industry_Design_Name, ParameterDirection.Input),
                    ...
                    new OracleParameter("P_CLASS_CONTENT", OracleDbType.Varchar2, pInfo.Class_Content == null ? "" : pInfo.Class_Content, ParameterDirection.Input),
