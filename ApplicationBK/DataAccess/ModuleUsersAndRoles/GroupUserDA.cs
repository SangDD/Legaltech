namespace DataAccess.ModuleUsersAndRoles
{
    ...
    public class GroupUserDA
    {
        public static DataSet GetGroupById(int groupId)
        {
            try
            {
                return OracleHelper.ExecuteDataset(Configuration.connectionString, CommandType.StoredProcedure, "pkg_s_groups.proc_GroupUser_GetById",
        ...
        public static DataSet GetAllGroups()
        {
            try
            {
                return OracleHelper.ExecuteDataset(Configuration.connectionString, CommandType.StoredProcedure, "pkg_s_groups.proc_GroupUser_GetAll",
                      new OracleParameter("p_cursor", OracleDbType.RefCursor, ParameterDirection.Output));
            }
            catch (Exception ex)
            {
        ...
        public static int EditGroup(GroupUserInfo groupEdit)
        {
            ...
            {
                var paramReturn = new OracleParameter("p_return", OracleDbType.Int32, ParameterDirection.Output);
                OracleHelper.ExecuteNonQuery(Configuration.connectionString, CommandType.StoredProcedure, "pkg_s_groups.proc_GroupUser_Edit",
                    ...
                    new OracleParameter("p_notes", OracleDbType.Varchar2, groupEdit.Notes, ParameterDirection.Input),
        ...
        public static int DeleteGroup(int groupId, string modifiedBy)
        {
            ...
            {
                var paramReturn = new OracleParameter("p_return", OracleDbType.Int32, ParameterDirection.Output);
                OracleHelper.ExecuteNonQuery(Configuration.connectionString, CommandType.StoredProcedure, "pkg_s_groups.proc_GroupUser_Delete",
                    new OracleParameter("p_groupId", OracleDbType.Int32, groupId, ParameterDirection.Input),
        ...
        public static int AddFunctionToGroupBatch(int[] arrGroupId, int[] arrFunctionId, int totalRecord)
        {
            ...
            {
                var paramReturn = new OracleParameter("p_return", OracleDbType.Int32, ParameterDirection.Output);
                OracleHelper.ExcuteBatchNonQuery(Configuration.connectionString, CommandType.StoredProcedure, "pkg_s_groups.proc_SetupFunctionToGroup", totalRecord,
        ...
        public static int DeleteFunctionFromGroup(int groupId)
        {
            ...
            {
                var paramReturn = new OracleParameter("p_return", OracleDbType.Int32, ParameterDirection.Output);
                OracleHelper.ExecuteNonQuery(Configuration.connectionString, CommandType.StoredProcedure, "pkg_s_groups.proc_DeleteFunctionFromGroup",
                    new OracleParameter("p_groupId", OracleDbType.Int32, groupId, ParameterDirection.Input),
                    paramReturn);
                var result = Convert.ToInt32(paramReturn.Value.ToString());
                return result;
        ...
        public static DataSet GetAllFunctionsByGroup(int groupId)
        {
            try
            {
                return OracleHelper.ExecuteDataset(Configuration.connectionString, CommandType.StoredProcedure, "pkg_s_groups.proc_GetAllFunctionInGroup",
                  new OracleParameter("p_groupId", OracleDbType.Int32, groupId, ParameterDirection.Input),
                  new OracleParameter("p_cursor", OracleDbType.RefCursor, ParameterDirection.Output));
            }
            catch (Exception ex)
